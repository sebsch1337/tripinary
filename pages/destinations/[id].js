...
export async function getServerSideProps(context) {
	...
	const coverImage = await getRandomPixabayImage(trip?.country);

	return {
		props: { id: id, destinationsDB, toDosDB, countryName: trip?.error ? "Not found" : trip.country, coverImage },
	};
}

export default function Destinations({ id, destinationsDB, toDosDB, countryName, coverImage }) {
